...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        config.setInstanceName("demo-service");
        ...
        if (env.acceptsProfiles(Constants.SPRING_PROFILE_DEVELOPMENT)) {
        	LOGGER.debug("Application is running with the \"dev\" profile, Hazelcast " +
        ...
        config.getMapConfigs().put("com.demo.*", initializeDomainMapConfig(jHipsterProperties));
